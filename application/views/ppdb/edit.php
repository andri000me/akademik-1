            ...
            <!-- <div class="panel-tools">
                ...
                <a class="btn btn-xs btn-link panel-close" href="#">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" value="<?php echo $siswa['nisn'] ?>" name="nisn" placeholder="MASUKAN NISN" id="form-field-1" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" value="<?php echo $siswa['tempat_lahir'] ?>" name="tempat_lahir" placeholder="TEMPAT LAHIR" id="form-field-1" class="form-control">
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <textarea name="alamat" value="<?php echo $siswa['alamat'] ?>" class="form-control"></textarea>
                        </div>

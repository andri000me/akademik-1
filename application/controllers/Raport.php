...
class Raport extends CI_Controller{
    ...
    function index(){
        ...
        // $rombel         =   "SELECT rb.kelas,jr.nama_jurusan, mp.nama_mapel
   ...
   function nilai_semester(){
    //    blok query info siswa
       ...
       $siswa = $this->db->query($sqlSiswa)->row_array();
        ...
        $pdf->SetFont('Arial','',8);
        $pdf->Cell(190,5,'Jl. Soekarno Hatta No.12, Tlogosari Kulon, Kec. Pedurungan, Kota Semarang, Jawa Tengah',1,1,'C');
